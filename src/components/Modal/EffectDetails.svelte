...
<div class="relative col-span-3">
  <button
    ...
    use:popover.button
    class="flex h-9 w-full items-center justify-between gap-2 rounded-md border border-slate-600 bg-slate-700 px-3 py-2 transition-colors hover:border-slate-500 md:h-10"
  >
