...
<ul
  class="grid list-none grid-cols-2 justify-between gap-1 rounded-full border border-slate-600 bg-slate-700 p-0 {buttonGrid}"
>
  {#each items as item}
    <li class="flex items-center justify-center rounded-full">
      <button
        ...
        class:hover:bg-slate-600={activeTabValue !== item.value}
