export const STAR5 = {
  hp: [
    717, 920, 1123, 1326, 1530, 1733, 1936, 2139, 2342, 2545, 2749, 2952, 3155,
    3358, 3561, 3764, 3967, 4171, 4374, 4577, 4780,
  ],
  atk: [
    47, 60, 73, 86, 100, 113, 126, 139, 152, 166, 179, 192, 205, 219, 232, 245,
    258, 272, 285, 298, 311,
  ],
  "hp%": [
    7, 9, 11, 12.9, 14.9, 16.9, 18.9, 20.9, 22.8, 24.8, 26.8, 28.8, 30.8, 32.8,
  ...
  em: [
    28, 35.9, 43.8, 51.8, 59.7, 67.6, 75.5, 83.5, 91.4, 99.3, 107.2, 115.2,
    123.1, 131.0, 138.9, 149.9, 154.8, 162.7, 170.6, 178.6, 186.5,
  ],
  energy: [
    7.8, 10.0, 12.2, 14.4, 16.6, 18.8, 21.0, 23.2, 25.4, 27.6, 29.8, 32.0, 34.2,
    36.4, 38.6, 40.8, 43.0, 45.2, 47.4, 49.6, 51.8,
  ],
  critrate: [
  ...
  critdmg: [
    9.3, 12.0, 14.6, 17.3, 19.9, 22.5, 25.2, 27.8, 30.5, 33.1, 35.7, 38.4, 41.0,
    43.7, 46.3, 49.0, 51.6, 54.2, 56.9, 59.6, 62.2,
  ],
  healing: [
...
export const STAR4 = {
  hp: [
    645, 828, 1011, 1194, 1377, 1559, 1742, 1925, 2108, 2291, 2474, 2657, 2839,
    3022, 3205, 3388, 3571,
  ],
  atk: [
    42, 54, 66, 78, 90, 102, 113, 125, 137149, 161, 173, 185, 197, 209, 221,
    232,
  ],
  "hp%": [
  ...
  critdmg: [
    8.4, 10.8, 13.1, 15.5, 17.9, 20.3, 22.7, 25.0, 27.4, 29.8, 32.2, 34.5, 36.9,
    39.3, 41.7, 44.1, 46.4,
  ],
  healing: [
