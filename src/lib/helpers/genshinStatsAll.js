...
var a = {
    dullblade: {
      ...
      promotion: [
        ...
        { maxlevel: 40, attack: 11.699999809265137 },
        { maxlevel: 50, attack: 23.299999237060547 },
        { maxlevel: 60, attack: 35 },
        { maxlevel: 70, attack: 46.70000076293945 }
      ]
    },
    silversword: {
      base: { attack: 32.93000030517578, specialized: 0 },
      curve: { attack: 'GROW_CURVE_ATTACK_101', specialized: 'GROW_CURVE_CRITICAL_101' },
      promotion: [
        { maxlevel: 20, attack: 0 },
        { maxlevel: 40, attack: 11.699999809265137 },
    ...
    coolsteel: {
      base: { attack: 38.74129867553711, specialized: 0.07660000026226044 },
      curve: { attack: 'GROW_CURVE_ATTACK_101', specialized: 'GROW_CURVE_CRITICAL_101' },
      specialized: 'FIGHT_PROP_ATTACK_PERCENT',
      promotion: [
        { maxlevel: 20, attack: 0 },
        { maxlevel: 40, attack: 19.5 },
        { maxlevel: 50, attack: 38.900001525878906 },
        { maxlevel: 60, attack: 58.400001525878906 },
        { maxlevel: 70, attack: 77.80000305175781 },
        { maxlevel: 80, attack: 97.30000305175781 },
        { maxlevel: 90, attack: 116.69999694824219 }
      ]
    },
    harbingerofdawn: {
      base: { attack: 38.74129867553711, specialized: 0.10199999809265137 },
      curve: { attack: 'GROW_CURVE_ATTACK_101', specialized: 'GROW_CURVE_CRITICAL_101' },
      specialized: 'FIGHT_PROP_CRITICAL_HURT',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    travelershandysword: {
      base: { attack: 39.875099182128906, specialized: 0.06373299658298492 },
      curve: { attack: 'GROW_CURVE_ATTACK_102', specialized: 'GROW_CURVE_CRITICAL_101' },
      specialized: 'FIGHT_PROP_DEFENSE_PERCENT',
      promotion: [
        { maxlevel: 20, attack: 0 },
        { maxlevel: 40, attack: 19.5 },
    ...
    darkironsword: {
      base: { attack: 38.74129867553711, specialized: 30.600000381469727 },
      curve: { attack: 'GROW_CURVE_ATTACK_101', specialized: 'GROW_CURVE_CRITICAL_101' },
      specialized: 'FIGHT_PROP_ELEMENT_MASTERY',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    skyridersword: {
      base: { attack: 37.60749816894531, specialized: 0.11333300173282623 },
      curve: { attack: 'GROW_CURVE_ATTACK_104', specialized: 'GROW_CURVE_CRITICAL_101' },
      specialized: 'FIGHT_PROP_CHARGE_EFFICIENCY',
      promotion: [
        { maxlevel: 20, attack: 0 },
        { maxlevel: 40, attack: 19.5 },
    ...
    favoniussword: {
      base: { attack: 41.067100524902344, specialized: 0.1333329975605011 },
    ...
    prototyperancour: {
      base: { attack: 43.734901428222656, specialized: 0.07506699860095978 },
    ...
    ironsting: {
      base: { attack: 42.4010009765625, specialized: 36 },
      curve: { attack: 'GROW_CURVE_ATTACK_201', specialized: 'GROW_CURVE_CRITICAL_201' },
      specialized: 'FIGHT_PROP_ELEMENT_MASTERY',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    blackclifflongsword: {
      base: { attack: 43.734901428222656, specialized: 0.07999999821186066 },
      curve: { attack: 'GROW_CURVE_ATTACK_202', specialized: 'GROW_CURVE_CRITICAL_201' },
      specialized: 'FIGHT_PROP_CRITICAL_HURT',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    theblacksword: {
      base: { attack: 42.4010009765625, specialized: 0.05999999865889549 },
      curve: { attack: 'GROW_CURVE_ATTACK_201', specialized: 'GROW_CURVE_CRITICAL_201' },
      specialized: 'FIGHT_PROP_CRITICAL',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    thealleyflash: {
      base: { attack: 45.06869888305664, specialized: 11.999987602233887 },
      curve: { attack: 'GROW_CURVE_ATTACK_203', specialized: 'GROW_CURVE_CRITICAL_201' },
      specialized: 'FIGHT_PROP_ELEMENT_MASTERY',
      promotion: [
        { maxlevel: 20, attack: 0 },
        { maxlevel: 40, attack: 25.899999618530273 },
    ...
    festeringdesire: {
      base: { attack: 42.4010009765625, specialized: 0.10000000149011612 },
      curve: { attack: 'GROW_CURVE_ATTACK_201', specialized: 'GROW_CURVE_CRITICAL_201' },
      specialized: 'FIGHT_PROP_CHARGE_EFFICIENCY',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    cinnabarspindle: {
      base: { attack: 41.067100524902344, specialized: 0.15013299882411957 },
      curve: { attack: 'GROW_CURVE_ATTACK_204', specialized: 'GROW_CURVE_CRITICAL_201' },
      specialized: 'FIGHT_PROP_DEFENSE_PERCENT',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    'prizedisshinblade-01': {
      base: { attack: 42.4010009765625, specialized: 0 },
      curve: { attack: 'GROW_CURVE_ATTACK_201', specialized: 'GROW_CURVE_CRITICAL_201' },
      specialized: 'FIGHT_PROP_ATTACK_PERCENT',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    'prizedisshinblade-02': {
      base: { attack: 42.4010009765625, specialized: 0.04500000178813934 },
      curve: { attack: 'GROW_CURVE_ATTACK_201', specialized: 'GROW_CURVE_CRITICAL_201' },
      specialized: 'FIGHT_PROP_ATTACK_PERCENT',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    skywardblade: {
      base: { attack: 45.9364013671875, specialized: 0.11999999731779099 },
    ...
    freedomsworn: {
      base: { attack: 45.9364013671875, specialized: 43.20000076293945 },
      curve: { attack: 'GROW_CURVE_ATTACK_301', specialized: 'GROW_CURVE_CRITICAL_301' },
      specialized: 'FIGHT_PROP_ELEMENT_MASTERY',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    summitshaper: {
      base: { attack: 45.9364013671875, specialized: 0.1080000028014183 },
      curve: { attack: 'GROW_CURVE_ATTACK_301', specialized: 'GROW_CURVE_CRITICAL_301' },
      specialized: 'FIGHT_PROP_ATTACK_PERCENT',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    primordialjadecutter: {
      base: { attack: 44.33580017089844, specialized: 0.09600000083446503 },
    ...
    keyofkhajnisut: {
      base: { attack: 44.33580017089844, specialized: 0.14399999380111694 },
      curve: { attack: 'GROW_CURVE_ATTACK_304', specialized: 'GROW_CURVE_CRITICAL_301' },
      specialized: 'FIGHT_PROP_HP_PERCENT',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    bloodtaintedgreatsword: {
      base: { attack: 37.60749816894531, specialized: 40.79999923706055 },
      curve: { attack: 'GROW_CURVE_ATTACK_104', specialized: 'GROW_CURVE_CRITICAL_101' },
      specialized: 'FIGHT_PROP_ELEMENT_MASTERY',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    whiteirongreatsword: {
      base: { attack: 38.74129867553711, specialized: 0.09560000151395798 },
      curve: { attack: 'GROW_CURVE_ATTACK_101', specialized: 'GROW_CURVE_CRITICAL_101' },
      specialized: 'FIGHT_PROP_DEFENSE_PERCENT',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    whiteblind: {
      base: { attack: 42.4010009765625, specialized: 0.11259999871253967 },
      curve: { attack: 'GROW_CURVE_ATTACK_201', specialized: 'GROW_CURVE_CRITICAL_201' },
      specialized: 'FIGHT_PROP_DEFENSE_PERCENT',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    blackcliffslasher: {
      base: { attack: 42.4010009765625, specialized: 0.11999999731779099 },
      curve: { attack: 'GROW_CURVE_ATTACK_201', specialized: 'GROW_CURVE_CRITICAL_201' },
      specialized: 'FIGHT_PROP_CRITICAL_HURT',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    talkingstick: {
      base: { attack: 43.734901428222656, specialized: 0.03999999910593033 },
      curve: { attack: 'GROW_CURVE_ATTACK_202', specialized: 'GROW_CURVE_CRITICAL_201' },
      specialized: 'FIGHT_PROP_CRITICAL',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    songofbrokenpines: {
      base: { attack: 49.137699127197266, specialized: 0.04500000178813934 },
      curve: { attack: 'GROW_CURVE_ATTACK_303', specialized: 'GROW_CURVE_CRITICAL_301' },
      specialized: 'FIGHT_PROP_PHYSICAL_ADD_HURT',
      promotion: [
        { maxlevel: 20, attack: 0 },
        { maxlevel: 40, attack: 31.100000381469727 },
    ...
    whitetassel: {
      base: { attack: 38.74129867553711, specialized: 0.050999999046325684 },
      curve: { attack: 'GROW_CURVE_ATTACK_101', specialized: 'GROW_CURVE_CRITICAL_101' },
      specialized: 'FIGHT_PROP_CRITICAL',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    halberd: {
      base: { attack: 39.875099182128906, specialized: 0.05106699839234352 },
      curve: { attack: 'GROW_CURVE_ATTACK_102', specialized: 'GROW_CURVE_CRITICAL_101' },
      specialized: 'FIGHT_PROP_ATTACK_PERCENT',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    blacktassel: {
      base: { attack: 37.60749816894531, specialized: 0.10213299840688705 },
      curve: { attack: 'GROW_CURVE_ATTACK_104', specialized: 'GROW_CURVE_CRITICAL_101' },
      specialized: 'FIGHT_PROP_HP_PERCENT',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    dragonsbane: {
      base: { attack: 41.067100524902344, specialized: 48 },
      curve: { attack: 'GROW_CURVE_ATTACK_204', specialized: 'GROW_CURVE_CRITICAL_201' },
      specialized: 'FIGHT_PROP_ELEMENT_MASTERY',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    deathmatch: {
      base: { attack: 41.067100524902344, specialized: 0.07999999821186066 },
      curve: { attack: 'GROW_CURVE_ATTACK_204', specialized: 'GROW_CURVE_CRITICAL_201' },
      specialized: 'FIGHT_PROP_CRITICAL',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    wavebreakersfin: {
      base: { attack: 45.06869888305664, specialized: 0.029999999329447746 },
      curve: { attack: 'GROW_CURVE_ATTACK_203', specialized: 'GROW_CURVE_CRITICAL_201' },
      specialized: 'FIGHT_PROP_ATTACK_PERCENT',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    staffofhoma: {
      base: { attack: 45.9364013671875, specialized: 0.14399999380111694 },
      curve: { attack: 'GROW_CURVE_ATTACK_301', specialized: 'GROW_CURVE_CRITICAL_301' },
      specialized: 'FIGHT_PROP_CRITICAL_HURT',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    calamityqueller: {
      base: { attack: 49.137699127197266, specialized: 0.035999998450279236 },
      curve: { attack: 'GROW_CURVE_ATTACK_303', specialized: 'GROW_CURVE_CRITICAL_301' },
      specialized: 'FIGHT_PROP_ATTACK_PERCENT',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    otherworldlystory: {
      base: { attack: 38.74129867553711, specialized: 0.08500000089406967 },
      curve: { attack: 'GROW_CURVE_ATTACK_101', specialized: 'GROW_CURVE_CRITICAL_101' },
      specialized: 'FIGHT_PROP_CHARGE_EFFICIENCY',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    emeraldorb: {
      base: { attack: 39.875099182128906, specialized: 20.399999618530273 },
      curve: { attack: 'GROW_CURVE_ATTACK_102', specialized: 'GROW_CURVE_CRITICAL_101' },
      specialized: 'FIGHT_PROP_ELEMENT_MASTERY',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    twinnephrite: {
      base: { attack: 39.875099182128906, specialized: 0.03400000184774399 },
      curve: { attack: 'GROW_CURVE_ATTACK_102', specialized: 'GROW_CURVE_CRITICAL_101' },
      specialized: 'FIGHT_PROP_CRITICAL',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    athousandfloatingdreams: {
      base: { attack: 44.33580017089844, specialized: 57.599998474121094 },
      curve: { attack: 'GROW_CURVE_ATTACK_304', specialized: 'GROW_CURVE_CRITICAL_301' },
      specialized: 'FIGHT_PROP_ELEMENT_MASTERY',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    slingshot: {
      base: { attack: 37.60749816894531, specialized: 0.06800000369548798 },
      curve: { attack: 'GROW_CURVE_ATTACK_104', specialized: 'GROW_CURVE_CRITICAL_101' },
      specialized: 'FIGHT_PROP_CRITICAL',
      promotion: [
        { maxlevel: 20, attack: 0 },
    ...
    messenger: {
      base: { attack: 39.875099182128906, specialized: 0.06800000369548798 },
      curve: { attack: 'GROW_CURVE_ATTACK_102', specialized: 'GROW_CURVE_CRITICAL_101' },
      specialized: 'FIGHT_PROP_CRITICAL_HURT',
      promotion: [
        { maxlevel: 20, attack: 0 },
...
var C = {
  calcStatsForCharacter: function (a, R) {
    const C = _[a];
    if (void 0 === C) return;
    ...
    const [l, c] = (function (_, e, a) {
      for (let R = _.length - 2; R >= 0; R--) {
        ...
        if (e === _[R].maxlevel)
          return (Number.isFinite(a) && a > R) || '+' === a
            ? [R + 1, _[R + 1]]
            : [R, _[R]];
      }
      return [0, _[0]];
    ...
    return (
      'FIGHT_PROP_CRITICAL' === C.specialized
        ? (E.specialized += C.base.critrate)
        : 'FIGHT_PROP_CRITICAL_HURT' === C.specialized &&
          (E.specialized += C.base.critdmg),
      E
    );
  },
  calcStatsForWeapon: function (_, e) {
    const C = a[_];
    if (void 0 === C) return;
    const t = C.promotion[C.promotion.length - 1].maxlevel;
    let [T, A] = (function (_) {
